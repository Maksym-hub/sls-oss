...
class Wait(Step):
    ...
    timestamp_path: str = None  # JSONPath to timestamp in input
...
class Pass(Step):
    ...
    result: Any = None
    result_path: str = None  # Where to put result in state
...
class HttpTask(Step):
    ...
    # Authentication
    connection_arn: str = None  # EventBridge connection ARN for auth
...
class Map(Step):
    ...
    items: List[Any] = None  # Or static list
...
class SQSTask(Step):
    ...
    delay_seconds: int = 0
    message_attributes: Dict[str, Any] = None
    message_group_id: str = None  # For FIFO queues
