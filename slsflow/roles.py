"""
Cross-account role access for slsflow pipelines.
...
Or via environment variables:
    export SLSFLOW_ROLE_DATA_WAREHOUSE="arn:aws:iam::111111111111:role/dw-role"
    export SLSFLOW_ROLE_ANALYTICS="arn:aws:iam::222222222222:role/analytics-role"

Usage:
    from slsflow.roles import roles
