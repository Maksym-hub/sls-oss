...
from typing import List, Optional, Dict, Any, Union, Callable, Tuple, TYPE_CHECKING
...
class Task:
    ...
    max_retry_delay: timedelta = None
    retry_exponential_backoff: bool = False
    
    execution_timeout: timedelta = field(default_factory=lambda: timedelta(hours=24))
    orchestration_timeout: timedelta = None  # How long to wait for deps. Defaults to execution_timeout
    ...
    payload: Dict[str, Any] = None  # Lambda payload
    invocation_type: str = "RequestResponse"  # or "Event" for async
    
    # === Glue-specific fields ===
    job_name: str = ""  # Glue job name
    glue_arguments: Dict[str, str] = None  # --arg=value pairs
    allocated_capacity: int = None  # DPUs
    worker_type: str = None  # G.1X, G.2X, etc.
    ...
    # === EMR-specific fields ===
    emr_cluster_id: str = ""
    emr_step: Dict[str, Any] = None
    
    # === Batch-specific fields ===
    job_definition: str = ""
    job_queue: str = ""
    batch_parameters: Dict[str, str] = None
...
class TaskDecorator:
    ...
    def _create_task(
        ...
        *,
        ...
        orchestration_timeout: timedelta = None,
        pool: str = "default",
        pool_slots: int = 1,
        priority_weight: int = 1,
        weight_rule: str = "downstream",
        ...
        job_name: str = "",
        glue_arguments: Dict[str, str] = None,
        ...
        batch_parameters: Dict[str, str] = None,
        # Asset-based orchestration
        outlets: List[Any] = None,
        inlets: List[Any] = None,
        wait_for: List[Any] = None,  # Assets to wait for (pull-based)
        # Backfill behavior
    ...
    def sfn(
        ...
        *,
        ...
        trigger_rule: TriggerRuleLiteral = "all_success",
        slack_channel: str = "",
        outlets: List[Any] = None,  # Assets this task produces
        inlets: List[Any] = None,   # Assets this task consumes
        wait_for: List[Any] = None,  # Assets to wait for (pull-based cross-pipeline)
        skip_on_backfill: bool = False,  # Skip this task during backfill runs
        **kwargs
    ) -> Union[Task, Callable]:
        """
