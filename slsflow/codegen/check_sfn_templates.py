...
def _load_canonical_status_values() -> Dict[str, Set[str]]:
    """Load canonical string values per enum family from slsflow.constants."""
    from slsflow.constants import (
...
def check_templates() -> int:
    ...
    if drift_findings:
        ...
        print("  (b) Adding the new value to slsflow/constants.TaskStatus")
        return 1
