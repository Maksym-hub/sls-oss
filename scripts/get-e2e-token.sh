...
#
# Why this exists: the E2E suite (tests/e2e/) needs SLSFLOW_ID_TOKEN when
# Cognito auth is enabled. slsflow uses SRP + admin-only users, so the plain
...
#   export SLSFLOW_ID_TOKEN="$(scripts/get-e2e-token.sh)"
